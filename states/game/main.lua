function load()
    ...
    world.tank = EntityManager.create("tank", { x = 400, y = 400, scale = .5, direction = "right"})
    world.lastCollision = {}
...
function love.draw()
    ...
    love.graphics.print("Barrel angle: " .. round(world.tank:getRelativeBarrelAngle()) .. " " .. round(world.tank:getBarrelDeg()), infoX, 32)
